...
namespace Formats {
    ...
    void DriverModule::ParseELF(ELF *elf) {
        ...
        const char* moduleStr = MODULE_SECTION_NAME;
        const char* relianceStr = MODULE_RELIANCE_SECTION_NAME;
        ...
        for (size_t i = 0; i < header->e_shnum; i++) {
            ...
            if (strcmp(sectionName, moduleStr) == 0) { // skip leading '.' in section name
                ...
                _isValid = true;
            } else if (strcmp(sectionName, relianceStr) == 0) {
